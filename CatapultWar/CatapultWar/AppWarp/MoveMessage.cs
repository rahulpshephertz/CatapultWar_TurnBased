...
namespace CatapultWar
{
    ...
    public class MoveMessage
    {
        ...
        {
            return System.Text.Encoding.UTF8.GetBytes(buildSHOTMessageString(ShotVelocity,ShotAngle));
        }
        public static String buildSHOTMessageString(String ShotVelocity, String ShotAngle)
        {
